;(load (merge-pathnames "graph-util" *load-truename*))
(load "graph-util")
...
(defun hash-edges (edge-list)
  "this function converts our edge list into a hash table"
...
(defun get-connected-hash (node edge-tab)
  "This function retrieves all the nodes connected to a starting node in Congestion City. It does the same as get-connected, but is optimized through hash tables"
